...
contract Domains is ERC721URIStorage {
    ...
    function register(string calldata name) public payable {
        ...
        // Create NFT metadata using Base64
            ...
            bytes(
                string(
                    abi.encodePacked(
                        '{"name": "',
                        _name,
                        '", "description": "A domain on the Charaktor name service", "image": "data:image/svg+xml;base64,',
